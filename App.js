...
import { Image, Animated, Text, View, Dimensions, ScrollView,StyleSheet, StatusBar } from 'react-native';
    ...
    >
      ...
      <View>
        ...
        {articleParagraphs.slice(0,3).map((text,index)=>{
          return <View key={`featured-${index}`} style={{flexDirection:'row',marginBottom:10}}>
